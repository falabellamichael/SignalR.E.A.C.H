...
// Reach Studio — edit helpers, ported verbatim from the VS Code extension's
// edits.js. Kept identical so the agent's edit_patch tool behaves exactly the
// same way in both hosts.
